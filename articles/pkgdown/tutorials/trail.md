...
#> ✔ Trail saved to /tmp/RtmpfjxQcv/my_analysis.rds
#> ✔ Report saved to /tmp/RtmpfjxQcv/my_analysis.qmd
#> ℹ Render with `quarto::quarto_render("/tmp/RtmpfjxQcv/my_analysis.qmd")`
```
