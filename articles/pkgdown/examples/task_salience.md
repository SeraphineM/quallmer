...
| 2021-Biden | democracy: pro , health: pro , unity: pro , foreign policy: pro, economy: pro , environment: pro   | The speech primarily focuses on the theme of democracy, emphasizing its triumph and the need to protect it, making ‘democracy: pro’ the most salient topic. Health is addressed through the discussion of the pandemic and the need to overcome it, leading to ‘health: pro’. Unity is a central theme, repeatedly mentioned as essential for progress, resulting in ‘unity: pro’. Foreign policy is touched upon with a commitment to re-engage with the world, hence ‘foreign policy: pro’. Economic issues are mentioned in the context of job loss and rebuilding, leading to ‘economy: pro’. The environment is addressed through the mention of a ‘cry for survival from the planet’, resulting in ‘environment: pro’. Each stance is determined by the positive language and commitment to addressing these issues. |
