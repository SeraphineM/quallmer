...
| 2025-Trump |    -3 | The text emphasizes national sovereignty, border control, and the exclusion of certain groups, such as ‘criminal aliens’ and ‘foreign gangs.’ It also highlights a return to traditional values and national homogeneity, such as the declaration of only two genders and the end of certain social policies. While there are mentions of unity and inclusion of various American demographics, the overall tone and policies suggested lean towards exclusivity. |
