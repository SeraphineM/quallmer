---
title: "Example: Ideology in political speeches"
subtitle: "Replicating Maerz & Schneider (2020)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example: Ideology in political speeches}
...
This example replicates the ideology scaling from [Maerz & Schneider (2020)](https://doi.org/10.1007/s11135-019-00885-7) using LLM-based coding with quallmer, and compares the results to the original dictionary approach.
...
The full corpus of 4,740 speeches is stored in the examples data folder (a 100-speech sample is available in the package as `data_speeches_ms2020_sample`):
